var Cuentas = [
    { id: 1, nombre: "Arnoldo Goméz", Password: "a", saldo: "10700" ,
    ...
    { id: 3, nombre: "René Salas", Password: "ElAlceMexicano1", saldo: "700" ,
    depositar: function(monto){
        var total = parseFloat(this.saldo)+parseFloat(monto);
        this.saldo = total.toString()
    },
    ...
    { id: 4, nombre: "Lila Lu", Password: "LiluPp", saldo: "700",
    depositar: function(monto){
        var total = parseFloat(this.saldo)+parseFloat(monto);
        this.saldo = total.toString()
    },
    ...
    { id: 5, nombre: "Andres Mx", Password: "#AndresChamps", saldo: "700" ,
    depositar: function(monto){
        var total = parseFloat(this.saldo)+parseFloat(monto);
        this.saldo = total.toString()
    },
